 ...
 * @author Amal
 */
public class MainMenuTouch extends javax.swing.JFrame {
     ...
     * @param Language
     */
    public MainMenuTouch(String Language) {
        initComponents();
        this.Lang = Language;
...
//        btnCloseApp.setOpaque(true);
    ...
    private void CustomizeUi() {
        ...
        panel.add(PanelReports, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 300, 280, 390));
...
//        pnlQuickAccess.add(lblSupplierManagement, new org.netbeans.lib.awtextra.AbsoluteConstraints(LabelLeft, LabelTop, LabelWidth, LabelHeight));
    ...
    private void initComponents() {
        ...
        panel.add(PanelReports, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 230, 280, 390));
        ...
        panel.add(pnlQuickAccess, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 620, 570));
        ...
        panel.add(lblnamePriceUpdate2, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 20, -1, -1));
        ...
        panel.add(lblLoggedUser, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 20, 170, 40));
        ...
        panel.add(btnCloseApp, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 20, 50, 50));
        ...
        panel.add(btnLastPrint, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 20, 40, 40));

        jLabel7.setFont(new java.awt.Font("Ubuntu Medium", 0, 18)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(0, 0, 102));
        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel7.setText("Last Print");
        panel.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 30, 120, -1));
    ...
    private void lblReOrderMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblReOrderMouseClicked
        try {
            ...
            Logger.getLogger(MainMenuTouch.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//        new Reports().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainMenuTouch.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainMenuTouch("test param").setVisible(true);
            }
        });
    }
